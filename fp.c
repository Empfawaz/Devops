...
void add_transaction(FPNode *root, int *transaction, int length, HeaderTableEntry *header_table) {
...
void build_fptree(int transactions[MAX_TRANSACTIONS][MAX_ITEMS], int num_transactions, int min_support, FPNode *root, HeaderTableEntry *header_table) {
